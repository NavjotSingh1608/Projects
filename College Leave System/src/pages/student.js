    ...
    <>
      ...
      >
        <h2 style={{ marginBottom: "1rem" }}>
          Welcome <span style={{ textTransform: "uppercase" }}>{req.name}</span>
        </h2>
      ...
      <Collapse in={alert}>
        <Alert severity="success">
          You have succesully created the request .Wait for teacher to respond{" "}
        </Alert>
      </Collapse>
      <Collapse in={alert1}>
      ...
      <Collapse in={alert2}>
        <Alert severity="error">
          Start Date is more than end date or dates are inappropriate
        </Alert>
      </Collapse>
      <br />
      ...
      <Stack
        ...
        marginBottom="50px"
      >
        <Button onClick={pushdata} variant="contained">
          {" "}
          Create Request{" "}
        </Button>
      </Stack>
      ...
      <Orders
        ...
        enddate={req.enddate}
        classper={req.per_class}
        hodper={req.hod_per}
        denail={req.denialreason}
        classper_once={req.per_once_class}
      />
    </>
  );
};
